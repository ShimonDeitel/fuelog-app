...
final class FuelogUITests: XCTestCase {
    ...
    func testAddEntryFlow() throws {
        ...
        nameField.tap()
        nameField.typeText("UI Test Vehicle")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Vehicle"].waitForExistence(timeout: 2))
    }
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Fuelog Pro"].waitForExistence(timeout: 2))
    }
